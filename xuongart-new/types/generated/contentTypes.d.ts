...
export interface ApiImageProjectImageProject extends Schema.CollectionType {
  collectionName: 'image_projects';
  info: {
    singularName: 'image-project';
    pluralName: 'image-projects';
    displayName: 'Image Project';
    description: 'D\u1EF1 \u00E1n h\u00ECnh \u1EA3nh ri\u00EAng bi\u1EC7t cho trang /portfolio/images';
  };
  options: {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::image-project.image-project', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::image-project.image-project': ApiImageProjectImageProject;
